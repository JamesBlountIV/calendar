...
import * as actions from "../../redux/reminderActions";
...
class TheDay extends React.Component {
  ...
  handleSetEdit = reminder => {
    this.props.handleEditDay(this.props.day);
      ...
      <article className={cssClasses}>
        {!this.props.editDay && (
          <button
            ...
            onClick={() => this.props.handleEditDay(this.props.day)}
          >
        ...
        {this.props.editDay === this.props.day ? (
          <ReminderForm
            ...
            handleEditDay={this.props.handleEditDay}
...
export default connect(mapStateToProps, mapDispatchToProps)(TheDay);
